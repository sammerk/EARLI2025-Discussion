...
logo: img/PHlogo.svg
footer: Slides {{< iconify streamline:creative-commons-solid >}}-{{< iconify fa6-brands:creative-commons-by >}}-licenced at https://ogy.de/merk026
...
:::: {.column width="40%"}
::: fragment
![](img/dogfooding.png){width="100%"}
:::
::::

:::: {.column width="60%"}
::: fragment
![See @hattie2007](img/FeedCircle.svg){width="80%"}
:::
::::
:::::::
...
-   **Paper 2** [@ehlert2025]:
    -   **RQ**: Do teachers’ beliefs \[...\] and behavior \[...\] change longitudinally during the implementation process? Can distinct clusters with specific trends be identified \[...\]?
